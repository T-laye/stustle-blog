...
import RegistrationForm from "../../../../../components/bigConference/form/RegistrationForm";
	...
	return (
		<div className="">
			...
			<div className="min-h-screen bg-white-background">
				<div className="hero_bg_conference px-4 pb-10 sm:pb-14 pt-20 lg:pt-40">
					<p className="mx-auto mb-4 w-fit rounded-full border border-primary-active bg-primary-activeCard px-4 py-2 text-center text-xs font-semibold uppercase tracking-[0.18em] text-primary">
						Registration
					</p>

					<h1 className="text-center text-4xl font-extrabold text-black sm:text-5xl">
						B.I.G Conference 2026
					</h1>
