...
const GenerateImage = () => {
  ...
  return (
    <section className="pt-10 sm:pt-20 lg:pt-40 px-4 sm:px-8 pb-20">
      <div className="container mx-auto max-md:space-y-8 md:flex justify-center gap-8">
          ...
          <div className="flex flex-col gap-4 max-w-[500px] mx-auto">
            <div className="flex flex-col gap-[10px]">
              ...
              <input
                ...
                className="h-[43px] px-2 w-full min-[1360px]:max-w-[800px] border border-[#AAAAAA] bg-transparent rounded-md text-base caret-primary placeholder:text-gray-300 placeholder:italic outline-none focus:border focus:border-primary duration-150"
              />
            </div>
            ...
            <div className="flex flex-col gap-[10px]">
              ...
              <div
                className={`relative border-2 overflow-hidden border-dashed rounded-md transition-all duration-200 w-full min-[1360px]:max-w-[800px] ${
                  dragOver
