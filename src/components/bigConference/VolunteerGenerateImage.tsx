...
import VolunteerInstaPost from "./VolunteerInstaPost";

const VolunteerGenerateImage = () => {
	...
	const handleGenerate = async () => {
		...
		try {
			...
			await downloadInstagramPost(
				name,
				selectedFile,
				"volunteer-instagram-post-preview",
			);
	...
	return (
		<section className="pb-20 pt-20 lg:pt-40 sm:px-8">
			<div className="max-w-[800px] mx-auto flex flex-col sm:flex-row-reverse items-center justify-center overflow-hidden">
				<div className="wfull mx-auto sm:w-1/2">
					<VolunteerInstaPost />
				</div>
				<div className="sm:w-1/2 px-5 max-sm:py-[30px] py-5 ">
					<div className="bgprimary border border-primary/10 backdrop-blur-[10px] rounded-tl-[10px] rounded-tr-[10px] textwhite py-[30px] px-4">
						<h2 className="text-xl font-medium text-center mb-7 ">
							Generate your Volunteers DP here
						</h2>
...
export default VolunteerGenerateImage;
