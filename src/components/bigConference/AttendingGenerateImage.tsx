...
import AttendingInstaPost from "./AttendingInstaPost";

const AttendingGenerateImage = () => {
	...
	const handleGenerate = async () => {
		...
		try {
			...
			await downloadInstagramPost(
				name,
				selectedFile,
				"attending-instagram-post-preview",
				"BIG-Attending",
			);
				...
				<div className="w-full px-5 max-sm:py-[30px] py-5 ">
					<div className="bg-primary/25 border border-primary/10 backdrop-blur-[10px] rounded-tl-[10px] rounded-tr-[10px] text-white py-[30px] px-4">
						<h2 className="text-xl font-medium text-center mb-7 ">
							Generate your &quot;I Will Be Attending&quot; Post
						</h2>

						<div className="flex flex-col gap-4 max-w-[500px] mx-auto">
							<div className="flex flex-col gap-[10px]">
								<label htmlFor="attendingFullName" className="text-sm font-medium">
									Name
								</label>
								<input
									type="text"
									name="attendingFullName"
									value={name}
									onChange={(e) => setName(e.target.value)}
									id="attendingFullName"
							...
							<div className="flex flex-col gap-[10px]">
								<label htmlFor="attendingPictureUpload" className="text-sm font-medium">
									Picture
								</label>
								...
								>
									<input
										type="file"
										name="attendingPictureUpload"
										id="attendingPictureUpload"
...
export default AttendingGenerateImage;
