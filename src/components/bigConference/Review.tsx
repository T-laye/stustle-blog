...
const ReviewCard = ({ comment, name }: { comment: string; name: string }) => {
	return (
		<div className="min-w-[600px] lg:min-w-[528px] h-[290px] rounded-lg p-4 bg-primary-light shadow-md flex flex-col justify-between">
			<div className="flex gap-2">
				<div className="h-12 min-w-12 w-12">
					<BsQuote className="text-5xl text-primary" />
				</div>
				<div>
					<p className="text-sm line-clamp-[11] text-center">{comment}</p>
				</div>
			</div>
			<div>
				<p>{name}</p>
